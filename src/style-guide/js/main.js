/*******************
	From Style Guide Template
	by CODYHOUSE
	http://codyhouse.co/gem/css-style-guide-template
********************/
...
jQuery(document).ready(function($){
	...
	********************/
	...
	/*******************
		buttons
	********************/
	var buttonsWrapper = $('#buttons .sg-box'),
		buttonsHtml = buttonsWrapper.html(),
		containerHtml = $('<div class="sg-box"></div>').insertAfter(buttonsWrapper),
