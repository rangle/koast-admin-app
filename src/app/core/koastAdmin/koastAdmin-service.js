 ...
 */
angular.module('koastAdminApp.core.koastAdmin.koastAdmin-service', ['koastAdminApp.core.constants']).service('koastAdmin', ['koastAdmin_HTTP_MOCK', 'KOAST_ROOT', 'ADMIN_DISCOVERY_PATH', '$q', function (_koastHttp, KOAST_ROOT, ADMIN_DISCOVERY_PATH, $q) {
    ...
    var getRouteInfo = function (routes, functionality) {
        var routeInfo = _.chain(routes).filter(function (i) {
    ...
    var service = {
        ...
        load: function () {
            return _koastHttp.get(KOAST_ROOT + ADMIN_DISCOVERY_PATH, {
                ...
                supportedFunctionalityByType = _.chain(res).indexBy('type').value();
                ready.resolve();
                return res;
            });
        },
