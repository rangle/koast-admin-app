 ...
 */
angular.module('koastAdminApp.core.koastAdmin.koastAdmin-service', [
    'koastAdminApp.core.constants'
  ])
  .service('koastAdmin', ['koastAdmin_HTTP_MOCK', 'KOAST_ROOT',
    'ADMIN_DISCOVERY_PATH', '$q',
    function (_koastHttp, KOAST_ROOT, ADMIN_DISCOVERY_PATH, $q) {
      ...
      var getRouteInfo = function (routes, functionality) {
        ...
        if (routeInfo) {
          ...
          throw new Error('Koast Admin is not configured to support ' +
      ...
      var getHttpFunction = function (method) {
        ...
        default:
          throw new Error(
            'Unsupported _koastHTTP method received from koast admin configuration',
            method);
        }
      };
      ...
      var service = {
        ...
        load: function () {
          return _koastHttp.get(KOAST_ROOT + ADMIN_DISCOVERY_PATH, {
              cache: true
            })
            .then(function (res) {
        ...
        makeApiCall: function (type, method) {
          ...
          return whenReady()
            .then(function () {
              ...
              var route = getRouteInfo(supportedFunctionalityByType[
                type].routes, method);
              return getHttpFunction(route.method)(route.url, args[2],
                args[3]);
            });
        }
      };
  ...
  .service('koastAdmin_HTTP_MOCK', ['$q', 'KOAST_ROOT', 'ADMIN_DISCOVERY_PATH',
    function ($q, KOAST_ROOT, ADMIN_DISCOVERY_PATH) {
      var backUpStatuses = {};
      ...
      var service = {
        get: function (url, config) {
          ...
          case (KOAST_ROOT + ADMIN_DISCOVERY_PATH):
            result = [{
              ...
              routes: [{
                url: 'CREATE_BACKUP',
                method: 'POST',
                functionality: 'createBackup'
              }, {
                url: 'GET_BACKUPS',
                method: 'GET',
                functionality: 'getBackups'
              }, {
                url: 'RESTORE_BACKUP',
                method: 'POST',
                functionality: 'restoreBackup'
              }, {
                url: 'GET_BACKUP_STATUS',
                method: 'GET',
                functionality: 'getBackupStatus'
              }]
            }, {
              type: 'authentication',
              routes: [{
          ...
          case 'GET_BACKUP_STATUS':
            ...
            result = {
              completed: backUpStatuses[config.params.id] || 0
            };
            break;
          case 'test1':
            result = {};
            break;
          default:
            throw new Error('koastAdmin_HTTP_MOCK.get: Unexpect URL ' +
              url);
          }
        ...
        post: function (url, body, config) {
          ...
          case 'LOGOUT':
            ...
            break;
          default:
            throw new Error('koastAdmin_HTTP_MOCK.post: Unexpect URL ' +
              url);
            break;
          }
          return deferred.promise;
        ...
        put: function (url, body, config) {
          ...
          case 'test3':
            ...
            break;
          default:
            throw new Error('koastAdmin_HTTP_MOCK.put: Unexpect URL ' +
              url);
            break;
          }
          return deferred.promise;
