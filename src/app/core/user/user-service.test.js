...
//        return user.login('user', 'pass').then(function () {
...
//        return user.login('user', 'pass').then(user.logout).then(function () {
//            expect(user.isAuthenticated()).to.be.false;
...
//        return
//        user.login('user', 'pass').then(user.refreshToken).then(function () {
//            expect(user.isAuthenticated()).to.be.true;
//            expect(_token).to.not.be.null;
//        });
//    });
