...
angular.module('koastAdminApp.core.user.user-service', ['koastAdminApp.core.koastAdmin', 'koast']).service('user', ['koastAdmin', '_koastHttp', '$timeout', '_koastLogger', function (koastAdmin, _koastHttp, $timeout, _koastLogger) {
